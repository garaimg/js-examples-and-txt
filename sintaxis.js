...
alert('2' > 1); // true, string '2' se convierte a nÃºmero 2
alert('01' == 1); // true, string '01' se convierte a nÃºmero 1
...
if (hora < 10 || hora > 18 || esDomingo) {
    alert('La tienda estÃ¡ cerrada.'); // es domigo
}
...
if (nombre == 'Amaia' && edad == 30) {
    alert('Se llama Amaia y tiene 30 aÃ±os');
}
